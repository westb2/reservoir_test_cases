...
if RELEASE_WATER:
    directory_running = f'simulations/WY{year_run}_with_reservoir_releasing_15715_test'
else:
    directory_running = f'simulations/WY{year_run}_with_reservoir_test'
...
# NETCDF Settings
write_netcdf = True
run.NetCDF.NumStepsPerFile          = 240
run.NetCDF.WritePressure            = write_netcdf
run.NetCDF.WriteSubsurface          = False
run.NetCDF.WriteSaturation          = write_netcdf
run.NetCDF.WriteCLM                 = write_netcdf
run.NetCDF.CLMNumStepsPerFile       = 240
run.NetCDF.NodeLevelIO              = False

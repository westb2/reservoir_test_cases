...
from Make_SoildFiles_fcn import make_solid_file


def run_model(run_name, rain_rate_1, rain_rate_2, reservoir_release_rate, initial_reservoir_storage):
    ...
    overland.Patch.slope1.BCPressure.Cycle = 'rainrec'
    overland.Patch.slope1.BCPressure.rain.Value = rain_rate_1
    overland.Patch.slope1.BCPressure.rec.Value = rain_rate_2
    # overland.Patch.slope1.BCPressure.alltime.Value = -0.00

    overland.Patch.slope2.BCPressure.Cycle = 'rainrec'
    overland.Patch.slope2.BCPressure.rain.Value = rain_rate_1
    overland.Patch.slope2.BCPressure.rec.Value = rain_rate_2
    # overland.Patch.slope2.BCPressure.alltime.Value = -0.00

    overland.Patch.channel.BCPressure.Cycle = 'rainrec'
    overland.Patch.channel.BCPressure.rain.Value = rain_rate_1
    overland.Patch.channel.BCPressure.rec.Value = rain_rate_2
    # overland.Patch.channel.BCPressure.alltime.Value = -0.00
    ...
    overland.Solver.PrintReservoirs = True
    ...
    overland.Geom.domain.ICPressure.FileName = os.path.abspath("./domain_files/tilted_v_with_reservoir_initial_pressure.pfb")
    ...
    solid_name = os.path.abspath("./domain_files/Xriver_nx25_dz0.5")
    solid_fname = solid_name + '.pfsol'
    # make_solid_file(nx=gridnx, ny=gridny,
    #                 bottom_val=1, side_val=2, top_val1=3, top_val2=4, top_val3=5,
    #                 latsize=griddx, zdepth=griddz, river_dir=1,
    #                 root_name=solid_name, out_dir='./', pftools_path="./")
    ...
    cp(os.path.abspath("./domain_files/tilted_v_with_reservoir_initial_pressure.pfb"), run_dir)
    cp(os.path.abspath("./domain_files/tilted_v_with_reservoir_initial_pressure.pfb.dist"), run_dir)
    ...
    # slopex[:, MIDDLE_ROW+1, MIDDLE_ROW] = np.round(0.00,2)
    ...
    overland.Reservoirs.reservoir.Max_Storage = 50
    overland.Reservoirs.reservoir.Storage = initial_reservoir_storage
    overland.Reservoirs.reservoir.Min_Release_Storage = 25
    overland.Reservoirs.reservoir.Release_Rate = reservoir_release_rate

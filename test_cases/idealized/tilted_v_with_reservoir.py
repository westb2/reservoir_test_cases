...
def run_model(rain_rate_1, rain_rate_2, reservoir_release_rate):
    ...
    overland.TimingInfo.StopTime = 500.0
    ...
    cp("tilted_v_with_reservoir_initial_pressure.pfb", run_dir)
    cp("tilted_v_with_reservoir_initial_pressure.pfb.dist", run_dir)
    ...
    overland.Reservoirs.reservoir.Intake_Y = 13.5
    overland.Reservoirs.reservoir.Release_X = 13.5
    overland.Reservoirs.reservoir.Release_Y = 13.5
